					...
					<div id="rev_slider_579_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.1.4">
						<ul>   <!-- SLIDE  -->
							<li class="dark" data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/slides/modab-paints-slide-1.jpg"  data-saveperformance="off"  data-title="Welcome to Modab Paints">
								...
								data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;">Your one-stop paint solution Company</div>
								...
								data-endeasing="Power4.easeIn" style="z-index: 3; white-space: normal;">Welcome to MODAB PAINTS</div>
								...
								data-width="['800','800','560','400']"
								data-height="none"
								data-endeasing="Power4.easeIn" style="z-index: 3; width: 750px; max-width: 750px; white-space: normal;">We provide excellent and quality paint products to suite your aesthetic needs..</div>
							...
							<li class="dark" data-transition="slideup" data-slotamount="1" data-masterspeed="1000" data-thumb="images/slides/modab-paints-slide-3-black.jpg"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="High Quality Paints">
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;"><img src="images/slider/rev/main/s2-1.png" alt="Image">
								</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 6;"><img src="images/modab-paints-classic.png" alt="Image"></div>
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 9;"><img src="images/modab-paints-platinum.png" alt="Image"></div>
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 11; white-space: nowrap;">Readily Available Products?</div>
								...
								data-height="none"
								data-endeasing="Power4.easeIn" style="z-index: 11; font-size: 56px;white-space: nowrap;">High Quality Paints!</div>
								...
								data-height="none"
								data-endeasing="Power4.easeIn" style="z-index: 11; max-width: 550px; white-space: normal;"> Our paints contain a range of protective, decorative coating designed to enhance appearance, durability, functionality and aesthetics.</div>
							...
							<!-- MAIN IMAGE -->
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap; color: #222;">MODAB PAINTS</div>
								...
								data-endelementdelay="0.1"
								data-endspeed="1000"
								data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap; color: #222; line-height: 1.2; max-width: 450px; width: 450px; white-space: normal;">Producing Quality Affordable Paints...</div>
							</li>
						</ul>
					</div>
			...
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div class="mx-auto center clearfix" style="max-width: 900px;">
						<img class="bottommargin" src="images/logo.jpg" alt="Image">
						<h1>Welcome! This is <span>Modab Paints</span>.</h1>
						<h2>A home to great quality paints of different colors. Get the best paints that meet your taste.</h2>
						<a href="#" class="button button-3d button-dark button-large ">Browse Products</a>
						<a href="#" class="button button-3d button-large">Request Quote</a>
					</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-sm fbox-plain" data-animate="fadeIn">
								...
								<div class="fbox-content">
									...
									<p>We ensure that our products are very affordable so individuals and companies have access to quality paints for their personal use.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-sm fbox-plain" data-animate="fadeIn" data-delay="200">
								...
								<div class="fbox-content">
									...
									<p>We offer a wide range of colors in any shade you want as we understand that people have different tastes and preferences in colors.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-4">
							<div class="feature-box fbox-sm fbox-plain" data-animate="fadeIn" data-delay="400">
								...
								<div class="fbox-content">
									...
									<p>We make Our products readily available for our customer, and you can also order special quotes or requests on the paints you want.</p>
								</div>
							</div>
						</div>
				...
				<div class="section parallax dark mb-0 border-bottom-0" style="background-image: url('images/modabpaints-bg-1.jpg');padding-top:150px;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
					...
					<div class="container clearfix">
						...
						<div class="heading-block center">
							<h2 style="color:#F48631;">Modab Paints: About Us!</h2>
							<span>We are an indigenous company that produces a range of protective, decorative coating designed to enhance appearance, durability, functionality and aesthetics. We are reputable for producing high quality products.</span>
						</div>
						...
						<div style="position: relative; margin-bottom: -60px;" data-height-xl="415" data-height-lg="342" data-height-md="262" data-height-sm="160" data-height-xs="102">
							<img src="images/modab-paints-sizes.png" style="position: absolute; top: 0; left: 0;margin-left:260px;" data-animate="fadeInUp" alt="Modab Paints Buckets">
					...
					<div class="container clearfix">
						...
						<div class="row col-mb-50">
							<div class="col-sm-6 col-lg-3 text-center" data-animate="bounceIn">
								<i class="i-plain i-xlarge mx-auto mb-0 icon-money"></i>
								<div class="counter counter-lined"><span data-from="100" data-to="9942" data-refresh-interval="50" data-speed="2000"></span>K+</div>
								<h5>Buckets Sold</h5>
							</div>
							...
							<div class="col-sm-6 col-lg-3 text-center" data-animate="bounceIn" data-delay="200">
								...
								<div class="counter counter-lined"><span data-from="30" data-to="203" data-refresh-interval="100" data-speed="2500"></span>+</div>
								<h5>Happy Clients</h5>
							</div>
							...
							<div class="col-sm-6 col-lg-3 text-center" data-animate="bounceIn" data-delay="600">
								<i class="i-plain i-xlarge mx-auto mb-0 icon-bucket"></i>
								<div class="counter counter-lined"><span data-from="60" data-to="176" data-refresh-interval="30" data-speed="2700"></span>+</div>
								<h5>Referrals</h5>
							</div>
						</div>
                ...
                <div class="col-lg-4 dark col-padding overflow-hidden" style="background-color: #F48631;">
                    <div>
                        ...
                        <p style="line-height: 1.8;">Modab Paints is focused on producing paints that can be used on any material under any condition and still give the satisfaction required by our clients.</p>
                ...
                <div class="col-lg-4 dark col-padding overflow-hidden" style="background-color: #34495e;">
                    <div>
                        ...
                        <p style="line-height: 1.8;">Modab Paints aims to be among the leading paint manufacturing company in Africa, thereby giving our clients reasons to rely on us with perfect paint finishing.</p>
                        <a href="#" class="button button-border button-light button-rounded text-uppercase m-0">Read More</a>
                        <i class="icon-binoculars bgicon"></i>
                    </div>
                </div>

                <div class="col-lg-4 dark col-padding overflow-hidden" style="background-color: #e74c3c;">
                    <div>
                        <h3 class="text-uppercase" style="font-weight: 600;">Our Values</h3>
                        <p style="line-height: 1.8;">Modab Paints thrives on the satisfaction of clients, therefore we value excellence and durability in the products we manufacture and deliver to our clients.</p>
                        <a href="#" class="button button-border button-light button-rounded text-uppercase m-0">Read More</a>
				...
				<div class="section mb-0" style="margin-top: 0px;">
					<div class="container clearfix">
