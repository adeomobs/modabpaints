...
?>
		...
		<section id="page-title" class="page-title-parallax page-title-dark include-header" style="padding: 250px 0; background-image: url('images/modab-about-bg.jpg'); background-size: cover; background-position: center center;" data-bottom-top="background-position:0px 400px;" data-top-bottom="background-position:0px -500px;">
			...
			<div class="container clearfix">
				<h1>About Us</h1>
				<span>Creative world of art with beautiful colour paints</span>
				<ol class="breadcrumb">
		...
		<section id="content">
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div class="row col-mb-50 mb-0">
						...
						<div class="col-lg-4">
							...
							<p>Modab Paints is focused on producing paints that can be used on any material under any condition and still give the satisfaction required by our clients.</p>
						...
						<div class="col-lg-4">
							...
							<p>Modab Paints aims to be among the leading paint manufacturing company in Africa, thereby giving our clients reasons to rely on us with perfect paint finishing.</p>
						...
						<div class="col-lg-4">
							...
							<p>Modab Paints thrives on the satisfaction of clients, therefore we value excellence and durability in the products we manufacture and deliver to our clients.</p>
					...
					<div class="col-md-7 col-padding">
						<div>
							<div class="heading-block">
								<span class="before-heading color">Quality Paints</span>
								<h3 style="color:#34437A;">MODAB PAINTS</h3>
							</div>

							<div class="row col-mb-50">

								<div class="col-lg-12">
									<p>Modab Paints has been providing quality paints and stains for home owners and professionals for well over 5 years. Today, we line-up a well reputable residential, commercial and industrial paint brand that offers a wide range of choices to meet the varying needs of Consumers, Interior Designers, Painting Contractors, Property Managers, Developers and Architects around the globe.</p>
									<p>Our Products and Service Outshine others due to our prompts and quality service rendition. We also satisfy the interest of our customers by given them just what they love to see in a creative world of art with beautiful colour paints.</p>
					...
					<div class="col-md-7 col-padding" style="background-color: #F5F5F5;">
						<div>
							...
							<div class="row col-mb-50">
								...
								<div class="col-lg-12">
									<p style="text-align:center;margin-bottom: 0px;margin-top: 50px;">
										<img class="bottommargin" src="images/logo.jpg" alt="Image">
									</p>
									<p>Modab Paints is an indigenous company that produces a range of protective, decorative coating designed to enhance appearance, durability, functionality and aesthetics. We are reputable for producing high quality products.</p>
									<p>Our manufacturing capability and expertise is grounded in a solid understanding of what it takes to make professional coating products.</p>
									<!--<a href="#" class="social-icon inline-block si-small si-light si-rounded si-facebook">
										<i class="icon-facebook"></i>
										<i class="icon-facebook"></i>
									</a>
									...
									<ul class="skills">
										...
										<li data-percent="89">
											<span>Quantity</span>
											<div class="progress">
												<div class="progress-percent"><div class="counter counter-inherit counter-instant"><span data-from="0" data-to="89" data-refresh-interval="30" data-speed="1100"></span>%</div></div>
											</div>
										</li>
										<li data-percent="93">
											<span>Texture</span>
											<div class="progress">
												<div class="progress-percent"><div class="counter counter-inherit counter-instant"><span data-from="0" data-to="93" data-refresh-interval="30" data-speed="1100"></span>%</div></div>
											</div>
										</li>
										<li data-percent="87">
											<span>Brightness</span>
											<div class="progress">
												<div class="progress-percent"><div class="counter counter-inherit counter-instant"><span data-from="0" data-to="87" data-refresh-interval="30" data-speed="1100"></span>%</div></div>
											</div>
										</li>
										<li data-percent="91">
											<span>Affordability</span>
											<div class="progress">
												<div class="progress-percent"><div class="counter counter-inherit counter-instant"><span data-from="0" data-to="91" data-refresh-interval="30" data-speed="1100"></span>%</div></div>
											</div>
										</li>
									</ul>
								</div>
				...
				<div class="section footer-stick" style="background-color:#fff;">
